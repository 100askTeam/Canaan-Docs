import{_ as n,o as s,c as a,e}from"./app-e64799d6.js";const i={},l=e(`<h1 id="_6-makefile实例" tabindex="-1"><a class="header-anchor" href="#_6-makefile实例" aria-hidden="true">#</a> 6.Makefile实例</h1><p>在上面的例子中，我们都是把头文件，源文件放在同一个文件里面，这样不好用于维护，所以我们将其分类，把它变得更加规范一下，把所有的头文件放在文件夹：inc，把所有的源文件放在文件夹：src。 代码目录如下：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ tree
