import{_ as a,o as n,c as s,e}from"./app-e64799d6.js";const i={},l=e(`<h1 id="_3-变量" tabindex="-1"><a class="header-anchor" href="#_3-变量" aria-hidden="true">#</a> 3.变量</h1><h2 id="_3-1-变量的定义及取值" tabindex="-1"><a class="header-anchor" href="#_3-1-变量的定义及取值" aria-hidden="true">#</a> 3.1 变量的定义及取值</h2><p>Makefile 也支持变量定义，变量的定义也让的我们的 Makefile 更加简化，可复用。 变量的定义：一般采用大写字母，赋值方式像 C 语言的赋值方式一样，如下：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>DIR <span class="token operator">=</span> ./100ask/
