import{_ as l,r as s,o,c as _,d as e,w as n,b as a,e as t,a as d}from"./app-e64799d6.js";const c={},r=t('<h1 id="npu混合量化说明" tabindex="-1"><a class="header-anchor" href="#npu混合量化说明" aria-hidden="true">#</a> NPU混合量化说明</h1><h2 id="_1-前言" tabindex="-1"><a class="header-anchor" href="#_1-前言" aria-hidden="true">#</a> 1 前言</h2><h3 id="_1-1-读者对象" tabindex="-1"><a class="header-anchor" href="#_1-1-读者对象" aria-hidden="true">#</a> 1.1 读者对象</h3><p>本文档（本指南）主要适用于以下人员：</p><p>• 技术支持工程师</p><p>• 软件开发工程师</p><p>• AI 应用案客户</p><h2 id="_2-正文" tabindex="-1"><a class="header-anchor" href="#_2-正文" aria-hidden="true">#</a> 2 正文</h2><h3 id="_2-1-npu-开发简介" tabindex="-1"><a class="header-anchor" href="#_2-1-npu-开发简介" aria-hidden="true">#</a> 2.1 NPU 开发简介</h3><p>• 支持int8/uint8/int16 量化精度，运算性能可达1TOPS.</p><p>• 相较于GPU 作为AI 运算单元的大型芯片方案，功耗不到GPU 所需要的1%.</p><p>• 可直接导入Caffe, TensorFlow, Onnx, TFLite，Keras, Darknet, pyTorch 等模型格式.</p><p>• 提供AI 开发工具：支持模型快速转换、支持开发板端侧转换API、支持TensorFlow, TF Lite, Caffe, ONNX, Darknet, pyTorch 等模型.</p><p>• 提供AI 应用开发接口：提供NPU 跨平台API.</p><h3 id="_2-2-开发流程" tabindex="-1"><a class="header-anchor" href="#_2-2-开发流程" aria-hidden="true">#</a> 2.2 开发流程</h3><p>NPU 开发完整的流程如下图所示：</p><p><img src="http://photos.100ask.net/allwinner-docs/v853/AIApplication/image-20221208105945861.png" alt="image-20221208105945861"></p>',17),p=t(`<p>本篇以yolov5s 模型为例，来说明混合量化的具体步骤.</p><h3 id="_2-3-浮点部署" tabindex="-1"><a class="header-anchor" href="#_2-3-浮点部署" aria-hidden="true">#</a> 2.3 浮点部署</h3><p>浮点部署的目的是获取golden 数据，目的是可以和后面混合量化得到的数据比较相似度，来衡量混合量化的效果。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>pegasus.py import onnx --model yolov5s.onnx --output-data yolov5s.data --output-model yolov5s.json
