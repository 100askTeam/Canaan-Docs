import{_ as e,o as a,c as n,e as d}from"./app-e64799d6.js";const i={},s=d(`<h2 id="_3-编译方法介绍" tabindex="-1"><a class="header-anchor" href="#_3-编译方法介绍" aria-hidden="true">#</a> 3 编译方法介绍</h2><h3 id="_3-1-准备编译工具链" tabindex="-1"><a class="header-anchor" href="#_3-1-准备编译工具链" aria-hidden="true">#</a> 3.1 准备编译工具链</h3><p>准备编译工具链接执行步骤如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1）cd longan/brandy/brandy-2.0/\\
2）./build.sh -t
