import{_ as e,o as i,c as n,e as l}from"./app-e64799d6.js";const d={},s=l(`<h1 id="常见问题" tabindex="-1"><a class="header-anchor" href="#常见问题" aria-hidden="true">#</a> 常见问题</h1><h2 id="_6-faq" tabindex="-1"><a class="header-anchor" href="#_6-faq" aria-hidden="true">#</a> 6 FAQ</h2><h3 id="_6-1-常用-debug-方法" tabindex="-1"><a class="header-anchor" href="#_6-1-常用-debug-方法" aria-hidden="true">#</a> 6.1 常用 debug 方法</h3><h4 id="_6-1-1-利用-sunxi-dump-读写相应寄存器" tabindex="-1"><a class="header-anchor" href="#_6-1-1-利用-sunxi-dump-读写相应寄存器" aria-hidden="true">#</a> 6.1.1 利用 sunxi_dump 读写相应寄存器</h4><p>需要开启 SUNXI_DUMP 模块：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>make kernel_menuconfig
	---&gt; Device Drivers
