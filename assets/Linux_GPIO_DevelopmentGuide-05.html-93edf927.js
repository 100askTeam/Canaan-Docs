import{_ as n,o as i,c as e,e as s}from"./app-e64799d6.js";const d={},l=s(`<h2 id="_5-使用示例" tabindex="-1"><a class="header-anchor" href="#_5-使用示例" aria-hidden="true">#</a> 5 使用示例</h2><h3 id="_5-1-使用-pin-的驱动-dts-配置示例" tabindex="-1"><a class="header-anchor" href="#_5-1-使用-pin-的驱动-dts-配置示例" aria-hidden="true">#</a> 5.1 使用 pin 的驱动 dts 配置示例</h3><p>对于使用 pin 的驱动来说，驱动主要设置 pin 的常用的几种功能，列举如下：</p><p><em>•</em> 驱动使用者只配置通用 GPIO, 即用来做输入、输出和中断的</p><p><em>•</em> 驱动使用者设置 pin 的 pin mux，如 uart 设备的 pin,lcd 设备的 pin 等，用于特殊功能</p><p><em>•</em> 驱动使用者既要配置 pin 的通用功能，也要配置 pin 的特性</p><p>下面对常见使用场景进行分别介绍。</p><h4 id="_5-1-1-配置通用-gpio-功能-中断功能" tabindex="-1"><a class="header-anchor" href="#_5-1-1-配置通用-gpio-功能-中断功能" aria-hidden="true">#</a> 5.1.1 配置通用 GPIO 功能/中断功能</h4><p>用法一：配置 GPIO，中断，device tree 配置 demo 如下所示：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>soc{
    ...
    gpiokey {
        device_type = &quot;gpiokey&quot;; 
