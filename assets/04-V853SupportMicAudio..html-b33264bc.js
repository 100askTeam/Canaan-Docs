import{_ as i,r as d,o as t,c as l,a as e,d as n,e as s}from"./app-e64799d6.js";const c={},r=s(`<h1 id="开发板支持录音和播放音频" tabindex="-1"><a class="header-anchor" href="#开发板支持录音和播放音频" aria-hidden="true">#</a> 开发板支持录音和播放音频</h1><h2 id="_0-前言" tabindex="-1"><a class="header-anchor" href="#_0-前言" aria-hidden="true">#</a> 0.前言</h2><p>​ 本章主要讲述如何使用板载的MIC拾音咪头录音并使用喇叭播放音频。</p><p>​ 音频_开发指南：https://tina.100ask.net/SdkModule/Linux_AudioFrequency_DevelopmentGuide-02/#220-v853</p><p>​ 全志官方音频介绍：https://v853.docs.aw-ol.com/soft/tina_audio/#audio_1</p><h2 id="_1-硬件介绍" tabindex="-1"><a class="header-anchor" href="#_1-硬件介绍" aria-hidden="true">#</a> 1.硬件介绍</h2><p>​ V853 芯片提供了 AudioCodec（芯片内置音频接口） x1、I2S/PCM（数字音频接口） x2、DMIC（外置数字 MIC 接口） x1，可以满足各类音频需求。100ASK_V853-PRO开发板板载两个MIC拾音咪头和喇叭接口。如下图所示：</p><p><img src="http://photos.100ask.net/allwinner-docs/v853/DeviceDriver/image-20230505163212847.png" alt="image-20230505163212847"></p><p>如果您想要使用喇叭接口播放声音，需要外接一个喇叭</p><p><img src="http://photos.100ask.net/allwinner-docs/v853/DeviceDriver/image-20230506110123930.png" alt="image-20230506110123930"></p><h2 id="_2-音频驱动框架使用" tabindex="-1"><a class="header-anchor" href="#_2-音频驱动框架使用" aria-hidden="true">#</a> 2.音频驱动框架使用</h2><p>在 Tina Linux 中使用的是标准的 ALSA API，所以使用音频的功能可以使用标准的 <code>alsa-utils</code>。它提供了 <code>amixer</code>、<code>aplay</code>、<code>arecord</code> 等工具。在Tina根目录下输入<code>make menuconfig</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>book@100ask:~/workspaces/tina-v853-open$ make menuconfig
